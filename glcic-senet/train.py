...
from losses import completion_network_loss, contextual_loss
from utils import (
    gen_input_mask,
    gen_hole_area,
    crop,
...
parser.add_argument('--arc', type=str, choices=['celeba', 'places2', 'pascal'], default='celeba')
...
def main(args):
    ...
    while pbar.n < args.steps_1:
        ...
        for i, x in enumerate(train_loader):
            ...
            if cnt_bdivs >= args.bdivs:
                ...
                my_writer.add_scalar('mse_loss', loss_mse, pbar.n * len(train_loader) + i)
    ...
    while pbar.n < args.steps_2:
        for x in train_loader:
            ...
            output_real = model_cd((input_ld_real, input_gd_real)) # 输入局部判别器的生成图片
    ...
    while pbar.n < args.steps_3:
        for i, x in enumerate(train_loader):
            ...
            my_writer.add_scalar('mse_loss', loss_cn_1, (90000 + pbar.n) * len(train_loader) + i)
