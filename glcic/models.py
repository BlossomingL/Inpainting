...
import torch.nn as nn
from glcic.layers import Flatten, Concatenate
from glcic.senet_model.senet.se_resnet import se_resnet34


class CompletionNetwork_SE(nn.Module):
    def __init__(self):
        super(CompletionNetwork_SE, self).__init__()
        resnet = se_resnet34()
