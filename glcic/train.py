...
parser.add_argument('--mpv', nargs=3, type=float, default=[0.38617073545407427, 0.38726241791141647, 0.3816151928822916])
...
def main(args):
    ...
    if args.data_parallel:
        model_cn = DataParallel(model_cn, device_ids=[0, 1])
    if args.init_model_cn != None:
